...
import com.jaekapps.expensetracker.view.adapters.IncomeItemRecyclerAdapter;
...
public class IncomeFragment extends Fragment implements IncomeItemRecyclerAdapter.IncomeItemClickListener {
    ...
    public interface IncomeFragmentListener {
        ...
        void selectItemFromIncomeCategory(int position, String item_name);
    }
    ...
    public void selectItemFromIncomeCategory(int position, List<String> incomeCategoryListItemName) {
        ...
        incomeFragmentListener.selectItemFromIncomeCategory(position, incomeCategoryListItemName.get(position));
    }
}
