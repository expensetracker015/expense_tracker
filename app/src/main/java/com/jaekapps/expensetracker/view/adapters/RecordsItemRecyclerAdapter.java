...
public class RecordsItemRecyclerAdapter extends RecyclerView.Adapter<RecordsItemRecyclerAdapter.RecordsItemViewHolder> {
    ...
    public RecordsItemRecyclerAdapter(ArrayList<Integer> itemIconList, ArrayList<String> itemAmountList, ArrayList<String> itemDateList, ArrayList<String> itemNameList, int[] colors) {
