...
import com.jaekapps.expensetracker.view.adapters.MoreExpensesRecyclerAdapter;
...
public class ExpenseItemsListDialogBox extends DialogFragment {
    ...
    public ExpenseItemsListDialogBox(ArrayList<Integer> itemIconList, ArrayList<String> amountList, ArrayList<String> itemList, int[] colors) {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = layoutInflater.inflate(R.layout.dialog_expense_items_list, null);
